...
(function() {
  ...
  angieApp.config(function($translateProvider) {
    $translateProvider.translations('en', {
      ...
      DescriptionPetDate: "Mobile App for pet owners based on tinder. The app goal is to find a mate for your pet so they can breed. Avaiable only for Dogs and Cats",
      DescriptionMascotas: "Mobile app to report found and lost pets. The app lets you create a pet profile. to publish and share on social networks and the app itself. Also includes usefull information about pet care, vets centres, and pet adoption places",
    ...
    $translateProvider.translations('es', {
      ...
      DescriptionPetDate: "App mobile para dueños de mascotas basado en tinder. El objetivo de la App es encontrar una pareja para que sus mascotas se apareen y puedan tener crías. Sólo sisponible para perros y gatos",
      DescriptionMascotas: "App mobile para reportar mascotas perdidas y encontradas. La app consiste en subir una foto de la mascota y completar una ficha para luego subirla y difundirla para poder reunir a los deños con sus mascotas perdidas; también incluye información útil sobre el cuidado de la misma, centros de atención veterinaria, y centros de adopciones.",
      DescriptionTimes: " App mbile para personalización de alarmas y resrticción de actividad y notificaciones. El objetivo de la App es poder desvincularse del teléfono por periodos de tiempo previamente seteados, la app ignorará llamadas de grupos o particulares especificos y a su vez bloqueará apps y sus notificaciones. ",
    ...
    return $translateProvider.preferredLanguage('es');
  });
